...
function ArticlesControl() {
  ...
  return (
    <div className="articlesDelControl">
    <h1>Headers Del Control:</h1>
      <Form>
    ...
    <Button variant="outline-primary" onClick={(e) => {
      toDel.forEach(id => {
        console.log(id)
        axios.delete(`http://localhost:5001/navbar?id=${id}`).then(res => console.log(res))
      })
    }}>Submit</Button>
</Form>
    </div>
